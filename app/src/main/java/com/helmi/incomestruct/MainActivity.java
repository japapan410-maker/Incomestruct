...
public class MainActivity extends Activity {
    ...
    // ================= TAB 4: PENGATURAN LENGKAP PERSIS SCREENSHOT =================
    private void renderPengaturan() {
        TextView tvSub = new TextView(this);
        tvSub.setText("PREFERENSI LOKAL");
        tvSub.setTextSize(TypedValue.COMPLEX_UNIT_SP, 11);
        ...
        EditText etTargetTab = createInput("Target tabungan", String.valueOf(pref.getLong("target_tabungan", 10000000)));
        EditText etTargetEmg = createInput("Target dana darurat", String.valueOf(pref.getLong("target_darurat", 15000000)));
        containerContent.addView(etTargetTab);
        containerContent.addView(etTargetEmg);

        LinearLayout rowPct = new LinearLayout(this);
        rowPct.setOrientation(LinearLayout.HORIZONTAL);
        EditText etPctTab = createInput("Tabungan (%)", String.valueOf(pref.getInt("pct_tabungan", 10)));
        EditText etPctEmg = createInput("Darurat (%)", String.valueOf(pref.getInt("pct_darurat", 5)));
        ...
        EditText etPin = createInput("Buat PIN", pref.getString("app_pin", ""));
        etPin.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_VARIATION_PASSWORD);
        ...
        // 5. DATA PERANGKAT (BACKUP & RESTORE)
        TextView tvSec5 = new TextView(this);
        tvSec5.setText("🗑 Data perangkat");
        tvSec5.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
        tvSec5.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        lpBack.setMargins(0, 0, dpToPx(4), 0);
        btnBackup.setLayoutParams(lpBack);
        btnBackup.setOnClickListener(v -> Toast.makeText(MainActivity.this, "Data Berhasil Di-backup ke Penyimpanan Lokal!", Toast.LENGTH_SHORT).show());
        ...
        lpRest.setMargins(dpToPx(4), 0, 0, 0);
        btnRestore.setLayoutParams(lpRest);
        btnRestore.setOnClickListener(v -> Toast.makeText(MainActivity.this, "Data Berhasil Dipulihkan!", Toast.LENGTH_SHORT).show());
