...
public class MainActivity extends Activity {
    ...
    private void renderBeranda() {
        ...
        btnIn.setOnClickListener(v -> showFormDialog("in"));

        Button btnOut = createQuickBtn("- Pengeluaran", "#1E293B");
        btnOut.setOnClickListener(v -> showFormDialog("out"));

        Button btnTab = createQuickBtn("+ Tabungan", "#1E293B");
        btnTab.setOnClickListener(v -> showFormDialog("tabungan"));
